...
export default class Sotez extends AbstractTezModule {
    constructor(provider = 'http://127.0.0.1:8732', chain = 'main', options = {}) {
        ...
        this.account = ({ balance, spendable, delegatable, delegate, fee = this.defaultFee, gasLimit = 10600, storageLimit = 257, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const operation = [
                Object.assign({ kind: 'origination', balance: utility.mutez(balance), fee, gas_limit: gasLimit, storage_limit: storageLimit, manager_pubkey: this.key.publicKeyHash() }, params),
            ];
        ...
        this.prepareOperation = ({ operation, source, skipCounter = false, }) => {
            ...
            return Promise.all(promises).then(([header, metadata, manager, headCounter]) => __awaiter(this, void 0, void 0, function* () {
                ...
                const fullOp = yield forge.forge(opOb, counter, metadata.next_protocol);
        ...
        this.sendOperation = ({ operation, source, skipPrevalidation = false, skipSignature = false, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (skipSignature) {
                ...
                const signed = yield this.key.sign(fullOp.opbytes, watermark.generic);
         ...
         * }).then(result => console.log(result));
         */
        this.transfer = ({ to, amount, source, fee = this.defaultFee, parameters, gasLimit = 10600, storageLimit = 300, mutez = false, }) => {
            const operation = {
                kind: 'transaction',
                fee,
                gas_limit: gasLimit,
         ...
         */
        this.typecheckCode = (code, gas = 10000) => this.query(`/chains/${this.chain}/blocks/head/helpers/scripts/typecheck_code`, {
        ...
        this.runCode = (code, amount, input, storage, trace = false) => {
            ...
            return this.query(`/chains/${this.chain}/blocks/head/helpers/scripts/${ep}`, {
                ...
                storage: typeof storage === 'string' ? utility.sexp2mic(storage) : storage,
            });
        };
        /**
